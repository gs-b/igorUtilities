...
static function/s notes_getTimeStamp(notebookName)
...
#if ( exists("vdt2") && (itemsinlist(winlist("thorSlowWheels.ipf",";","WIN:128")) > 0) )	//only compile functions for integrating filter wheel into Notebooks if available
	...
	if (nbTsw_tracking)
#if ( exists("vdt2") && (itemsinlist(winlist("thorSlowWheels.ipf",";","WIN:128")) > 0) )	
